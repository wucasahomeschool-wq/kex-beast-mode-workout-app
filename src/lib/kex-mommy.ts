...
const POOL = {
  // Warmup & light
  marchInPlace: ex({ id: "m.march", name: "March in Place", emoji: "🚶‍♀️", base: 90, unit: "sec",
    how: H(["Stand tall.", "Lift knees to hip height, alternating.", "Swing your arms naturally."]),
    note: "Wake up those hips!" }),
  // Easy cardio fillers — high volume, low intensity.
  jumpingJacks: ex({ id: "m.jj", name: "Jumping Jacks", emoji: "🤸‍♀️", base: 40, unit: "reps",
    how: H(["Stand tall, arms at sides.", "Jump feet out while raising arms overhead.", "Jump back to start."]),
    note: "Classic. Timeless. Sweaty." }),
  highKnees: ex({ id: "m.highKnees", name: "High Knees", emoji: "🦵", base: 50, unit: "reps",
    how: H(["Stand tall.", "Drive one knee up to hip height, then the other.", "Pump your arms."]),
    note: "Count each knee lift." }),
  buttKicks: ex({ id: "m.buttKicks", name: "Butt Kicks", emoji: "🍑", base: 50, unit: "reps",
    how: H(["Jog lightly in place.", "Kick your heels back toward your glutes."]),
    note: "Hamstrings say hi." }),
  armCircles: ex({ id: "m.armCircles", name: "Big Arm Circles", emoji: "🔄", base: 30, unit: "reps",
    how: H(["Arms out to your sides.", "Circle forward for half, then backward for half."]),
    note: "Shoulders love this." }),
  jogInPlace: ex({ id: "m.jog", name: "Jog in Place", emoji: "🏃‍♀️", base: 90, unit: "sec",
    how: H(["Light jog, staying in one spot.", "Land softly on the balls of your feet."]),
    note: "Steady and easy." }),
  sideSteps: ex({ id: "m.sideSteps", name: "Side-to-Side Steps", emoji: "↔️", base: 40, unit: "reps",
    how: H(["Step wide to one side, then bring the other foot to meet it.", "Reverse direction. Count each step."]),
    note: "Little shuffle." }),
  toeTouches: ex({ id: "m.toeTouches", name: "Standing Toe Touches", emoji: "🤲", base: 20, unit: "reps",
    how: H(["Stand tall.", "Bend forward and reach for your toes.", "Rise back up."]),
    note: "Bendy time." }),
  shadowBox: ex({ id: "m.shadowBox", name: "Shadow Boxing", emoji: "🥊", base: 60, unit: "sec",
    how: H(["Feet shoulder-width apart.", "Throw alternating punches out in front of you.", "Stay light on your feet."]),
    note: "Pretend Kex disrespected you." }),
  wallPushup: ex({ id: "m.wallPushup", name: "Wall Push-Ups", emoji: "🧱", base: 15, unit: "reps",
  ...
  gluteBridge: ex({ id: "m.bridge", name: "Glute Bridges", emoji: "🌉", base: 18, unit: "reps",
    how: H(["Lie on your back, knees bent, feet flat.", "Squeeze glutes and lift hips.", "Lower with control."]),
    note: "Booty pop." }),
  bodySquat: ex({ id: "m.squat", name: "Chair Squats", emoji: "🪑", base: 18, unit: "reps",
  ...
  standingCrunch: ex({ id: "m.standingCrunch", name: "Standing Crunches", emoji: "🧍‍♀️", base: 22, unit: "reps",
  ...
  calfRaise: ex({ id: "m.calf", name: "Calf Raises", emoji: "🐮", base: 30, unit: "reps",
    how: H(["Stand tall.", "Rise up onto the balls of your feet.", "Lower slowly."]),
    note: "Hold a wall for balance if you'd like." }),
  seatedRow5: ex({ id: "m.seatedRow5", name: "Seated Rows (5 lb)", emoji: "🚣‍♀️", base: 16, unit: "reps",
  ...
  weightedSquat8: ex({ id: "m.wSquat8", name: "Weighted Squats (8 lb)", emoji: "🏋️‍♀️", base: 14, unit: "reps",
  ...
  weightedLunge5: ex({ id: "m.wLunge5", name: "Weighted Lunges (5 lb)", emoji: "🚶", base: 14, unit: "reps",
...
/** Resting exercises drawn from the whole pool. Cardio fillers front-load the warm-up. */
const SEQUENCE: Array<(m: number) => MommyExercise> = [
  POOL.marchInPlace,
  POOL.jumpingJacks, POOL.armCircles, POOL.jogInPlace,
  POOL.highKnees, POOL.buttKicks, POOL.sideSteps,
  POOL.toeTouches, POOL.shadowBox,
