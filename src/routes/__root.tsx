...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The silliest, most effective bodyweight workout app. Train your abs, legs, and upper body with Kex — the 7-year-old beast." },
      { property: "og:title", content: "GET RIPPED WITH KEX" },
      { property: "og:description", content: "Bodyweight beast mode training with Kex." },
