...
export function TimerRing({
  ...
  return (
    <div className={`relative inline-flex h-[160px] w-[160px] items-center justify-center ${last3 ? "animate-shake" : ""}`}>
      ...
      <div className={`relative text-center ${last3 ? "animate-danger-pulse" : ""}`}>{children}</div>
    </div>
  );
}
